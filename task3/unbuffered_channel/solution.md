...
unbuffered_channel.h - реализация канала
test.cpp - заданные тесты
benchmark.cpp - заданные бенчмарки
CMakeLists.txt - заданный файл для сборки конфигурации
...
Воскольку виртуальная среда действительно скромная было решение на ещё одной среде:
